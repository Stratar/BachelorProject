...
def ppg(model_file, load_after_iters, restore_model_from_file=1, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
        ...
        train_aux_iters=4, aux_iters=48, lam=0.97, max_ep_len=1000, target_kl=0.01, logger_kwargs=dict(), save_freq=5, viz=False):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--steps', type=int, default=768)#4000#1536
